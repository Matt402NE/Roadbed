namespace Roadbed.Test.Unit.Mocks;
...
/// <remarks>
/// This class is used to test the <see cref="CommonClassWithLogging{TCategoryName}"/> class.
/// </remarks>
public class UnitSimpleEntity<TCategoryName> :
    CommonClassWithLogging<TCategoryName>
{
